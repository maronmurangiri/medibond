...
require __DIR__ . 'php-mpesa-integration/vendor/autoload.php';
...
function lipaNaMpesaPassword()
{
    ...
    //passkey
    $passKey ="";
   ...
   {
       $consumer_key="ATqbfoG1pRrwAjJo0ZD9CzjLpODTOcvT";
       $consumer_secret="CJe7AGSso0jWqZr7";
   ...
   function stkPush($amount)
   {
       ...
       $curl_post_data = [
            ...
            'PartyA' => "254700606978",
            'PartyB' => 174379,
            'PhoneNumber' => "254700606978",
            'CallBackURL' => 'https://files.000webhost.com/Mpesaresponse.php',
            'AccountReference' => "Medibond LTD",
