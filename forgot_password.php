...
<?php 
	 // This  allows a user to reset their password, if forgotten.
	...
	<?php
	 ...
	 <div class="reset";><h1>Reset Your Password</h1>
	 <p><b>Enter your email address below and your password will be reset.</b></p>
