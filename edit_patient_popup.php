...
.form-containere input[type=text], .form-containere input[type=password] {
  width: 100%;
  padding: 15px;
  margin: 5px 0 22px 0;
  border: none;
...
.form-containere input[type=text]:focus, .form-containere input[type=password]:focus {
...
.form-containere .btn:hover, .open-button:hover {
  opacity: 1;
}
.save{
    padding-left: 5px;
...
<div class="form-popupe" id="myeForm">
  <form action="edit_patient.php" method="post" class="form-containere">
    <h1><b style="padding-right: 10px;"><i class="fas fa-edit"></i></b>Edit patient</h1>
  ...
  <label for="female">Female</label><br><br>
    ...
    <button type="button" class="btn cancel" onclick="closeeForm()">Back to Patients</button>
  </form>
</div>

<script>
function openeForm() {
  document.getElementById("myeForm").style.display = "block";
}

function closeeForm() {
  document.getElementById("myeForm").style.display = "none";
}
</script>
